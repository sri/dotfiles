...
(add-hook 'shell-mode-hook
          (lambda ()
            ...
            (my-define-key shell-mode-map (kbd "C-<down>")
              'comint-next-prompt)
            (my-define-key shell-mode-map (kbd "C-c e")
              'my-shell-erase-buffer)
            (my-define-key shell-mode-map (kbd "<right>")
              'my-shell-forward-char-or-previous-history)
            (my-define-key shell-mode-map (kbd "<down>")
              'my-shell-next-line-or-next-history)
            (my-define-key shell-mode-map (kbd "M-.")
