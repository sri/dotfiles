...
(defun my/apply-solarized-dark-face-overrides ()
  ...
  (custom-theme-set-faces
   ...
   ;; '(magit-diff-added-highlight ((t (:foreground "#fdf6e3" :background "#5f8700" :weight bold))))
   ;; '(magit-diff-removed ((t (:foreground "#af3a32" :background "#3a2020" :weight normal))))
   ;; '(magit-diff-removed-highlight ((t (:foreground "#fdf6e3" :background "#af3a32" :weight bold))))
