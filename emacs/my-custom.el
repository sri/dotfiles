...
(custom-set-faces
 ...
 '(org-todo ((((class color) (min-colors 89)) (:weight normal :foreground "#A9552B" :box (:line-width 1 :color "#A9552B"))))))
 '(org-done ((((class color) (min-colors 89)) (:weight normal :foreground "#8c9a43" :box (:line-width 1 :color "#8c9a43"))))))
